import HeroBanner from '../components/sections/HomeMain/HeroBanner';
import homeBanner from '../assets/images/HomeImages/home-banner.png';
...
const HomePage = () => {
  return (
    <>
      <HeroBanner backgroundImage={homeBanner} />
      <HomeSection1 />
      <HomeSection2 />
      <HomeSection3 />
